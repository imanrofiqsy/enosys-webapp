...
window.addEventListener("DOMContentLoaded", () => {
    let socket = new WebSocket('ws://127.0.0.1:8001/ws/chat/');

    socket.onopen = () => {
        console.log("✅ WebSocket Connected");
        socket.send(JSON.stringify({ message: "dashboard" }));
    };
    ...
    socket.onmessage = (event) => {
        ...
        document.getElementById("value_box1").textContent = data.value_box1 || "-";
        document.getElementById("unit_box1").textContent = data.unit_box1 || "";
    };
